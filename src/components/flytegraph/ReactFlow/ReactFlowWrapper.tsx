...
const CustomNodeTypes = {
    ...
    FlyteNode_subworkflow: RFCustomNodeSubworkflow,
...
const LayoutRC: React.FC<LayoutRCProps> = ({
    ...
    /* strore is only populated onLoad for flow */
...
export const ReactFlowWrapper: React.FC<RFWrapperProps> = ({
    ...
    const onLoad = rf => {
        console.log('onLoad:rf:', rf);
        setReactFlowInstance(rf);
    };

    /* Prevent nested graphs from zooming in too tightly */
    // const maxZoom = type == RFGraphTypes.nested ? 1 : 3;
    // console.log('maxZoom:', maxZoom, type);
